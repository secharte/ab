...
public class SimpleJasonAgent extends AgArch {
    ...
    public static void main(String[] a) {
    	...
    	System.out.println("TRAZA DEL AGENTE EN MODO G-JASON CON PRIORIDADES");
    ...
    public SimpleJasonAgent() {
        ...
        try {
            Agent ag = new Agent();
            setTS(ag.initAg(this, new DefaultBeliefBase(), "agente_supervisor.asl", new Settings()));
 ...
 //       l.add(Literal.parseLiteral("x(10)"));
    ...
    public void act(ActionExec action, List<ActionExec> feedback) {
    	//System.out.println("ENTRE ACCCCAAAAAAAAAAAAAA");
